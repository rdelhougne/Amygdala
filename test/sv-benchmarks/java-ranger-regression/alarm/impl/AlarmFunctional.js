...
class AlarmFunctional {
	...
	checkOverInfusionFlowRate(localB) {
		var ov;
		...
		if (localB.inTherapy) {
			/* Transition: '<S1>:4062' */
			var div1 = Divs32.divS32(localB.toleranceMax, 100);
			var div2 = Divs32.divS32(localB.toleranceMin, 100);
