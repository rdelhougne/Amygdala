...
public class ASTVisualizer {
    ...
    public ASTVisualizer(Node root_node) {
        ...
        MutableNode root = mutNode(visualization_node_name).add(getNodeContents(node_type, root_node.getSourceSection()));
    ...
    private void build_visualization(Node current_node, MutableNode current_vis_node) { // Parents created me and gave me my identity
    ...
    private Label getNodeContents(String node_type, SourceSection node_source) {
        ...
        return Label.html("<table><tr><td balign='center'><font face='LiberationMono'><b>" + node_type + "</b></font></td></tr><tr><td balign='left'><font face='LiberationMono'>" + source + "</font></td></tr></table>");
    }
}
